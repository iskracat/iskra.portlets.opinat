...
#from iskra.porltets.opinat import OpinatPortletMessageFactory as _


class IOpinatPortlet(IPortletDataProvider):
    """A portlet
...
class Renderer(base.Renderer):
    ...
    render = ViewPageTemplateFile('opinatportlet.pt')
...
class AddForm(base.AddForm):
    ...
    """
    form_fields = form.Fields(IOpinatPortlet)
